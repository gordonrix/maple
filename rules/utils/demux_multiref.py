...
def demultiplex_bam(bam_path, output_dir, barcode_info, partition_groups,
    ...
    Args:
        ...
        tag: Sample tag
        references_csv: CSV file with columns: sequence_name, alignment
    ...
    reference_seqs = dict(zip(ref_df['sequence_name'], ref_df['alignment'].str.upper()))
...
def main():
    ...
    if 'snakemake' in globals():
        ...
        parser.add_argument('--references_csv', required=True, help='References CSV file with columns: sequence_name, alignment')

...
def plot_violin(df, include_AA, group_col, x_label):
    """
    ...
    if include_AA:
        ...
        colors = [cc.kb[255], cc.kb[150]]
        both_plot = df.hvplot.violin(y='substitution_count', by=[group_col,'substitution_type'], c='substitution_type',
                        ylabel='substitutions per sequence', xlabel=x_label, legend=True, cmap=colors,
        ...
        AA_plot = df[df['substitution_type']=='AA'].hvplot.violin(y='substitution_count', by=group_col, c=group_col,
                        ylabel='substitutions per sequence', xlabel=x_label, colormap='blues',
...
if __name__ == '__main__':
    main(snakemake.input[0], snakemake.output[0], snakemake.params.group_col, snakemake.params.x_label, snakemake.params.export_SVG)